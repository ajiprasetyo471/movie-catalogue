...
import FavoriteMovieSeachPresenter from './liked-movies/favorite-movie-search-presenter';
...
const Like = {
  ...
  async afterRender() {
    ...
    new FavoriteMovieSeachPresenter({ view, favoriteMovies: FavoriteMovieIdb });
  },
};
